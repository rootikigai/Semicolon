                                ...
                                switch (messageSettingsMenu) {
                                    case 1 -> {
                                        ...
                                        switch (set1Menu) {
                                            ...
                                            default -> System.out.println("Invalid selection. Select a number from the menu: ");
                                        }
                                    }
                                    case 2 -> {
...
Select Menu (Enter corresponding number): """;
                        ...
                        System.out.print("To go back to main menu, press 0: ");
                        callRegisterMenu = input.nextInt();
                    }
                    break;
...
Select Menu (Enter corresponding number): """;
                ...
                default:
                    System.out.println("Invalid selection. You are back to the main menu!");
            }
        }
    }
}
